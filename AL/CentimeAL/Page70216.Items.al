    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(IsVariantMandatory; Rec.IsVariantMandatory)
                {
                    Caption = 'IsVariantMandatory';
                }
                field("SalesQty"; Rec."Qty. on Sales Order")
                {
                    Caption = 'SalesQty';
                }
                field("PurchasesQty"; Rec."Qty. on Purch. Order")
                {
                ...
                field("InventoryQty"; Rec."Inventory")
                {
                    Caption = 'InventoryQty';
                }
                field(gtin; Rec.GTIN)
                {
                    Caption = 'GTIN';

...
page 70204 "CustomerPayments"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(applyCustomerEntries; "ApplyCustomerEntries")
                {
                    Caption = 'Apply Customer Entries';
                    EntityName = 'applyCustomerEntry';
                    EntitySetName = 'applyCustomerEntries';
                    SubPageLink = "Customer Id" = field("Customer Id"), "Gen. Journal Line Id" = field(SystemId);
                }
            }
        }
    }
    ...
    var
        CustomerLedgerEntryBuffer: Record "CustomerLedgerEntryBuffer";
    begin
        SetCalculatedFields();
    end;
    ...
    var
        ...
        GraphMgtCustomerPayments: Codeunit "GraphMgtCustomerPayments";
    ...
    begin
        GenJrnl.SetRange("Journal Batch Name", Rec."Journal Batch Name");
